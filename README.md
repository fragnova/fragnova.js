...
This repository is an NPM Workspace (i.e Mono-Repo) that contains the code of the following NPM Packages that can be used to interact with the [Fragnova Blockchain](https://github.com/fragcolor-xyz/fragnova):
