...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    accounts: {
       ...
       **/
      externalID2Account: AugmentedQuery<ApiType, (arg: PalletAccountsExternalID | { Discord: any } | string | Uint8Array) => Observable<Option<PalletAccountsAccountInfo>>, [PalletAccountsExternalID]> & QueryableStorageEntry<ApiType, [PalletAccountsExternalID]>;
      /**
    ...
    protos: {
       ...
       **/
      protosByCategory: AugmentedQuery<ApiType, (arg: ProtosCategories | { Text: any } | { Trait: any } | { Shards: any } | { Audio: any } | { Texture: any } | { Vector: any } | { Video: any } | { Model: any } | { Binary: any } | string | Uint8Array) => Observable<Option<Vec<U8aFixed>>>, [ProtosCategories]> & QueryableStorageEntry<ApiType, [ProtosCategories]>;
      /**
       ...
       **/
      protosByOwner: AugmentedQuery<ApiType, (arg: PalletProtosProtoOwner | { User: any } | { ExternalAsset: any } | string | Uint8Array) => Observable<Option<Vec<U8aFixed>>>, [PalletProtosProtoOwner]> & QueryableStorageEntry<ApiType, [PalletProtosProtoOwner]>;
      /**
