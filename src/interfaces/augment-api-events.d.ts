...
declare module '@polkadot/api-base/types/events' {
    interface AugmentedEvents<ApiType extends ApiTypes> {
        accounts: {
             ...
             **/
            Linked: AugmentedEvent<ApiType, [sender: AccountId32, ethKey: H160], {
                sender: AccountId32;
                ethKey: H160;
            }>;
            /**
             ...
             **/
            Locked: AugmentedEvent<ApiType, [ethKey: H160, balance: u128, locktime: u64], {
                ethKey: H160;
                balance: u128;
                locktime: u64;
            }>;
             ...
             **/
            SponsoredAccount: AugmentedEvent<ApiType, [sponsor: AccountId32, sponsored: AccountId32, externalId: PalletAccountsExternalID], {
                sponsor: AccountId32;
             ...
             **/
            Unlinked: AugmentedEvent<ApiType, [sender: AccountId32, ethKey: H160], {
                sender: AccountId32;
                ethKey: H160;
            }>;
            /**
             ...
             **/
            Unlocked: AugmentedEvent<ApiType, [ethKey: H160, balance: u128], {
                ethKey: H160;
                balance: u128;
            }>;
            /**
        ...
        assets: {
             ...
             **/
            ApprovalCancelled: AugmentedEvent<ApiType, [assetId: u64, owner: AccountId32, delegate: AccountId32], {
                assetId: u64;
                owner: AccountId32;
             ...
             **/
            ApprovedTransfer: AugmentedEvent<ApiType, [assetId: u64, source: AccountId32, delegate: AccountId32, amount: u128], {
                assetId: u64;
                source: AccountId32;
                delegate: AccountId32;
                amount: u128;
             ...
             **/
            AssetFrozen: AugmentedEvent<ApiType, [assetId: u64], {
                assetId: u64;
            }>;
            /**
             * An asset has had its attributes changed by the `Force` origin.
             **/
            AssetStatusChanged: AugmentedEvent<ApiType, [assetId: u64], {
                assetId: u64;
            }>;
            /**
             * Some asset `asset_id` was thawed.
             **/
            AssetThawed: AugmentedEvent<ApiType, [assetId: u64], {
                assetId: u64;
            }>;
            /**
             * Some assets were destroyed.
             **/
            Burned: AugmentedEvent<ApiType, [assetId: u64, owner: AccountId32, balance: u128], {
                assetId: u64;
                owner: AccountId32;
                balance: u128;
            }>;
             ...
             **/
            Created: AugmentedEvent<ApiType, [assetId: u64, creator: AccountId32, owner: AccountId32], {
                assetId: u64;
                creator: AccountId32;
                owner: AccountId32;
            }>;
             ...
             **/
            Destroyed: AugmentedEvent<ApiType, [assetId: u64], {
                assetId: u64;
            }>;
            /**
             * Some asset class was force-created.
             **/
            ForceCreated: AugmentedEvent<ApiType, [assetId: u64, owner: AccountId32], {
                assetId: u64;
                owner: AccountId32;
            }>;
            /**
             ...
             **/
            Frozen: AugmentedEvent<ApiType, [assetId: u64, who: AccountId32], {
                assetId: u64;
                who: AccountId32;
            }>;
            /**
             ...
             **/
            Issued: AugmentedEvent<ApiType, [assetId: u64, owner: AccountId32, totalSupply: u128], {
                assetId: u64;
                owner: AccountId32;
                totalSupply: u128;
            }>;
             ...
             **/
            MetadataCleared: AugmentedEvent<ApiType, [assetId: u64], {
                assetId: u64;
            }>;
            /**
             * New metadata has been set for an asset.
             **/
            MetadataSet: AugmentedEvent<ApiType, [assetId: u64, name: Bytes, symbol_: Bytes, decimals: u8, isFrozen: bool], {
                assetId: u64;
                name: Bytes;
                symbol: Bytes;
                decimals: u8;
             ...
             * The owner changed.
             **/
            OwnerChanged: AugmentedEvent<ApiType, [assetId: u64, owner: AccountId32], {
                assetId: u64;
                owner: AccountId32;
            }>;
            /**
             ...
             **/
            TeamChanged: AugmentedEvent<ApiType, [assetId: u64, issuer: AccountId32, admin: AccountId32, freezer: AccountId32], {
                assetId: u64;
                issuer: AccountId32;
                admin: AccountId32;
                freezer: AccountId32;
             ...
             **/
            Thawed: AugmentedEvent<ApiType, [assetId: u64, who: AccountId32], {
                assetId: u64;
                who: AccountId32;
            }>;
            /**
             ...
             **/
            Transferred: AugmentedEvent<ApiType, [assetId: u64, from: AccountId32, to: AccountId32, amount: u128], {
                assetId: u64;
                from: AccountId32;
                to: AccountId32;
                amount: u128;
             ...
             **/
            TransferredApproved: AugmentedEvent<ApiType, [assetId: u64, owner: AccountId32, delegate: AccountId32, destination: AccountId32, amount: u128], {
                assetId: u64;
                owner: AccountId32;
                delegate: AccountId32;
        ...
        detach: {
            Detached: AugmentedEvent<ApiType, [fragmentDataHash: U8aFixed, remoteSignature: Bytes], {
                fragmentDataHash: U8aFixed;
                remoteSignature: Bytes;
            }>;
            MetadataChanged: AugmentedEvent<ApiType, [fragmentDataHash: U8aFixed, remoteSignature: Bytes], {
                fragmentDataHash: U8aFixed;
                remoteSignature: Bytes;
            }>;
            Patched: AugmentedEvent<ApiType, [fragmentDataHash: U8aFixed], {
                fragmentDataHash: U8aFixed;
            }>;
            Transferred: AugmentedEvent<ApiType, [fragmentDataHash: U8aFixed, accountId: AccountId32], {
                fragmentDataHash: U8aFixed;
                accountId: AccountId32;
            }>;
            Uploaded: AugmentedEvent<ApiType, [fragmentDataHash: U8aFixed], {
                fragmentDataHash: U8aFixed;
            }>;
            /**
             * Generic event
        ...
        fragments: {
             ...
             **/
            DefinitionCreated: AugmentedEvent<ApiType, [definitionHash: U8aFixed], {
                definitionHash: U8aFixed;
            }>;
            /**
             * A Fragment Definition metadata has changed
             **/
            DefinitionMetadataChanged: AugmentedEvent<ApiType, [fragmentHash: U8aFixed, metadataKey: Bytes], {
                fragmentHash: U8aFixed;
                metadataKey: Bytes;
            }>;
            /**
             * End Resale of Instance
             **/
            EndResale: AugmentedEvent<ApiType, [definitionHash: U8aFixed, fragmentId: ITuple<[u64, u64]>], {
                definitionHash: U8aFixed;
                fragmentId: ITuple<[u64, u64]>;
            }>;
            /**
             * Fragment Expiration event
             **/
            Expired: AugmentedEvent<ApiType, [accountId: AccountId32, definitionHash: U8aFixed, fragmentId: ITuple<[u64, u64]>], {
                accountId: AccountId32;
                definitionHash: U8aFixed;
                fragmentId: ITuple<[u64, u64]>;
            }>;
             ...
             **/
            InstanceMetadataChanged: AugmentedEvent<ApiType, [fragmentHash: U8aFixed, editionId: u64, copyId: u64, metadataKey: Bytes], {
                fragmentHash: U8aFixed;
                editionId: u64;
                copyId: u64;
                metadataKey: Bytes;
             ...
             **/
            InventoryAdded: AugmentedEvent<ApiType, [accountId: AccountId32, definitionHash: U8aFixed, fragmentId: ITuple<[u64, u64]>], {
                accountId: AccountId32;
                definitionHash: U8aFixed;
                fragmentId: ITuple<[u64, u64]>;
            }>;
             ...
             **/
            InventoryRemoved: AugmentedEvent<ApiType, [accountId: AccountId32, definitionHash: U8aFixed, fragmentId: ITuple<[u64, u64]>], {
                accountId: AccountId32;
                definitionHash: U8aFixed;
                fragmentId: ITuple<[u64, u64]>;
            }>;
             ...
             **/
            InventoryUpdated: AugmentedEvent<ApiType, [accountId: AccountId32, definitionHash: U8aFixed, fragmentId: ITuple<[u64, u64]>], {
                accountId: AccountId32;
                definitionHash: U8aFixed;
                fragmentId: ITuple<[u64, u64]>;
            }>;
             ...
             **/
            Publishing: AugmentedEvent<ApiType, [definitionHash: U8aFixed], {
                definitionHash: U8aFixed;
            }>;
            /**
             * Resell Instance
             **/
            Resell: AugmentedEvent<ApiType, [definitionHash: U8aFixed, fragmentId: ITuple<[u64, u64]>], {
                definitionHash: U8aFixed;
                fragmentId: ITuple<[u64, u64]>;
            }>;
            /**
             ...
             **/
            Unpublishing: AugmentedEvent<ApiType, [definitionHash: U8aFixed], {
                definitionHash: U8aFixed;
            }>;
            /**
             * Generic event
        ...
        protos: {
             ...
             **/
            Detached: AugmentedEvent<ApiType, [protoHash: U8aFixed, cid: Bytes], {
                protoHash: U8aFixed;
                cid: Bytes;
            }>;
            /**
             ...
             **/
            MetadataChanged: AugmentedEvent<ApiType, [protoHash: U8aFixed, cid: Bytes], {
                protoHash: U8aFixed;
                cid: Bytes;
            }>;
            /**
             ...
             **/
            Patched: AugmentedEvent<ApiType, [protoHash: U8aFixed, cid: Bytes], {
                protoHash: U8aFixed;
                cid: Bytes;
            }>;
            /**
             * Stake was created
             **/
            Staked: AugmentedEvent<ApiType, [protoHash: U8aFixed, accountId: AccountId32, balance: u128], {
                protoHash: U8aFixed;
                accountId: AccountId32;
                balance: u128;
            }>;
             ...
             **/
            Transferred: AugmentedEvent<ApiType, [protoHash: U8aFixed, ownerId: AccountId32], {
                protoHash: U8aFixed;
                ownerId: AccountId32;
            }>;
            /**
             * Stake was unlocked
             **/
            Unstaked: AugmentedEvent<ApiType, [protoHash: U8aFixed, accountId: AccountId32, balance: u128], {
                protoHash: U8aFixed;
                accountId: AccountId32;
                balance: u128;
            }>;
             ...
             **/
            Uploaded: AugmentedEvent<ApiType, [protoHash: U8aFixed, cid: Bytes], {
                protoHash: U8aFixed;
                cid: Bytes;
            }>;
            /**
        ...
        proxy: {
             ...
             * A proxy was added.
             **/
            ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: Null, delay: u64], {
             ...
             * A proxy was removed.
             **/
            ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: Null, delay: u64], {
                delegator: AccountId32;
                delegatee: AccountId32;
                proxyType: Null;
                delay: u64;
             ...
             **/
            PureCreated: AugmentedEvent<ApiType, [pure: AccountId32, who: AccountId32, proxyType: Null, disambiguationIndex: u16], {
                pure: AccountId32;
                who: AccountId32;
                proxyType: Null;
